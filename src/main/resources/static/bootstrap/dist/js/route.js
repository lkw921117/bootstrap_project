    ...
    case 1:
      switch (LeftMenu) {
        case 1:
          ...
          $('#_selectHistory').html('<a href="dashboard.html">메인</a> > Dashboard');
    ...
    case 2:
      switch (LeftMenu) {
        case 1:
          ...
          $('#_selectHistory').html('<a href="member.html">회원관리</a> > 회원조회');
          console.log('회원관리-회원조회-회원조회 --> 컨텐츠표시');
          break;
        case 2:
          $('#_selectTitle').html('문의조회');
          $('#_selectHistory').html('<a href="member.html">회원관리</a> > 문의조회');
          console.log('회원관리-문의관리-문의조회 --> 컨텐츠표시');
          break;
        case 3:
          $('#_selectTitle').html('자주쓰는답변');
          $('#_selectHistory').html('<a href="member.html">회원관리</a> > 자주쓰는답변');
          console.log('회원관리-문의관리-자주쓰는답변 --> 컨텐츠표시');
          break;
        case 4:
          $('#_selectTitle').html('회원메모조회');
          $('#_selectHistory').html('<a href="member.html">회원관리</a> > 회원메모조회');
    ...
    case 3:
      switch (LeftMenu) {
        case 1:
          ...
          $('#_selectHistory').html('<a href="request.html">신청관리</a> > 서비스 신청현황조회');
          console.log('신청관리-신청관리-서비스신청현황조회 --> 컨텐츠표시');
          break;
        case 2:
          $('#_selectTitle').html('견적서 신청현황조회');
          $('#_selectHistory').html('<a href="request.html">신청관리</a> > 견적서 신청현황조회');
    ...
    case 4:
      switch (LeftMenu) {
        case 1:
          ...
          $('#_selectHistory').html('<a href="pay.html">결제관리</a> > 결제내역조회');
          console.log('결제관리-결제관리-결제내역조회 --> 컨텐츠표시');
          break;
        case 2:
          $('#_selectTitle').html('결제수동등록');
          $('#_selectHistory').html('<a href="pay.html">결제관리</a> > 결제수동등록');
          console.log('결제관리-결제관리-결제수동등록 --> 컨텐츠표시');
          break;
        case 3:
          $('#_selectTitle').html('증빙서류 신청내역');
          $('#_selectHistory').html('<a href="pay.html">결제관리</a> > 증빙서류신청내역');
    ...
    case 5:
      switch (LeftMenu) {
        case 1:
          ...
          $('#_selectHistory').html('<a href="board.html">게시판관리</a> > FAQ 관리');
          console.log('게시판관리-게시판관리-FAQ관리 --> 컨텐츠표시');
          break;
        case 2:
          $('#_selectTitle').html('이용약관관리');
          $('#_selectHistory').html('<a href="board.html">게시판관리</a> > 이용약관관리');
          console.log('게시판관리-게시판관리-이용약관관리 --> 컨텐츠표시');
          break;
        case 3:
          $('#_selectTitle').html('공지사항관리');
          $('#_selectHistory').html('<a href="board.html">게시판관리</a> > 공지사항관리');
          console.log('게시판관리-게시판관리-공지사항관리 --> 컨텐츠표시');
          break;
        case 4:
          $('#_selectTitle').html('블로그관리');
          $('#_selectHistory').html('<a href="board.html">게시판관리</a> > 블로그관리');
    ...
    case 6:
      switch (LeftMenu) {
        case 1:
          ...
          $('#_selectHistory').html('<a href="promotion.html">프로모션</a> > 할인관리');
    ...
    case 7:
      switch (LeftMenu) {
        case 1:
          ...
          $('#_selectHistory').html('<a href="product.html">상품관리</a> > 상품조회');
          console.log('상품관리-메인서비스관리-상품조회 --> 컨텐츠표시');
          break;
        case 2:
          $('#_selectTitle').html('상품등록');
          $('#_selectHistory').html('<a href="product.html">상품관리</a> > 상품등록');
          console.log('상품관리-메인서비스관리-상품등록 --> 컨텐츠표시');
          break;
        case 3:
          $('#_selectTitle').html('이용기간설정');
          $('#_selectHistory').html('<a href="product.html">상품관리</a> > 이용기간설정');
          console.log('상품관리-상품옵션관리-이용기간설정 --> 컨텐츠표시');
          break;
        case 4:
          $('#_selectTitle').html('용량증설');
          $('#_selectHistory').html('<a href="product.html">상품관리</a> > 용량증설');
          console.log('상품관리-상품옵션관리-부가서비스설정-용량증설 --> 컨텐츠표시');
          break;
        case 5:
          $('#_selectTitle').html('법인카드연동');
          $('#_selectHistory').html('<a href="product.html">상품관리</a> > 법인카드연동');
          console.log('상품관리-상품옵션관리-부가서비스설정-법인카드연동 --> 컨텐츠표시');
          break;
        case 6:
          $('#_selectTitle').html('메신져');
          $('#_selectHistory').html('<a href="product.html">상품관리</a> > 메신져');
    ...
    case 8:
      switch (LeftMenu) {
        case 1:
          ...
          $('#_selectHistory').html('<a href="setting.html">환경설정</a> > 관리자조회');
          console.log('환경설정-고객센터관리-관리자조회 --> 컨텐츠표시');
          break;
        case 2:
          $('#_selectTitle').html('관리자등록');
          $('#_selectHistory').html('<a href="setting.html">환경설정</a> > 관리자등록');
